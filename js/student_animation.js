...
master.set([studentWhole,stars,circle],{css:{display:'block'}})
    ...
    .add( iconsFloating(),'circleEnd -= .95')
...
function iconsFloating (){
    var tl = new TimelineMax();
    tl.staggerFrom(servicesIcons,1, {transformOrigin:"50% 50%",scale:0,opacity:0,left:'50%',rotation:100, top:'50%',ease:Back.easeOut},0.1)
    return tl;
}
